<table class="table table-bordered table-hover">
                        ...
                        <?php
                             ...
                             if(isset($_GET['change_to_admin'])){
                                 $make_admin_id = $_GET['change_to_admin'];
                              ...
                              if(isset($_GET['change_to_moderator'])){
                                $make_moderator_id = $_GET['change_to_moderator'];
                                $query = "UPDATE users SET user_role = 'Moderator' WHERE user_id = $make_moderator_id";
                                $make_moderator_query = mysqli_query($connection,$query);
                                header("Location:users.php");
                            }
